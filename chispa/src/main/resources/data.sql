...
CREATE TABLE IF NOT EXISTS profile (
  ...
  preferredRelationship ENUM(
    'FRIENDSHIP', 'CASUAL', 'SERIOUS', 'LONG_TERM',
    'OPEN', 'HOOKUP', 'MARRIAGE', 'NOT_SURE'
  ) DEFAULT 'FRIENDSHIP',
...
VALUES(1, 'Ana', 'García', 'FEMALE', '1994-06-12', 'Madrid', 'Hola, soy Ana y me encanta conocer gente nueva.', 'música, viajes, cine', 'https://randomuser.me/api/portraits/women/1.jpg', 1, '2025-05-13 09:32:00', 'FRIENDSHIP'),
      ...
      (21, 'Eva', 'Ramos', 'FEMALE', '1993-03-11', 'Madrid', 'Me gusta el yoga y las caminatas largas.',
       'yoga, naturaleza', 'https://randomuser.me/api/portraits/women/21.jpg', 1, '2025-06-03 08:00:00', 'LONG_TERM') ON DUPLICATE KEY
...
VALUES
    ...
    (19, 20, 35, 60, 'MALE'),
    (20, 18, 35, 100, 'FEMALE'),
    (21, 25, 35, 50, 'MALE') ON DUPLICATE KEY
UPDATE user_id=user_id;